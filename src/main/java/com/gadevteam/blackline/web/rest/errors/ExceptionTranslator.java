package com.gadevteam.blackline.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.gadevteam.blackline.service.EmailAlreadyUsedException ||
            ex instanceof com.gadevteam.blackline.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.gadevteam.blackline.service.InvalidPasswordException
